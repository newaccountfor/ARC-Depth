...
# }
model_path = {
    'hrnet18_imagenet': '/home/sdb/ouyuxiang/pretrained-model/hrnetv2_w18_imagenet_pretrained.pth',
    'hrnet32_imagenet': '/home/sdb/ouyuxiang/pretrained-model/hrnetv2_w32_imagenet_pretrained.pth',
    'hrnet48_imagenet': '/home/sdb/ouyuxiang/pretrained-model/hrnetv2_w48_imagenet_pretrained.pth',
    'hrnet48_cityscapes': '/home/sdb/ouyuxiang/pretrained-model/hrnetv2_w48_imagenet_pretrained (1).pth'
}
...
class HighResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        features.append(x[1])
        features.append(x[2])
        # mixed_features = [list18] + [list36] + [list72] + 
        features.append(x[3])
